...
export default function CookiePolicyPage() {
    const [activeSection, setActiveSection] = useState(cookiePolicyData.sections[0].id);
        ...
        <>
            ...
            <main className="privacy-main">
                <div className="privacy-header-container">
                    <h1 className="privacy-heading">Cookie <span>Policy</span></h1>
                </div>
                <div className="privacy-container">
                    ...
                    <div className="privacy-content">
                        {(cookiePolicyData.sections as PolicySection[]).map((section: PolicySection) => (
                            <section
                                key={section.id}
                                id={section.id}
