...
export default function TermsOfServicePage() {
    const [activeSection, setActiveSection] = useState(termsOfServiceData.sections[0].id);
        ...
        <>
            ...
            <main className="privacy-main">
                <div className="privacy-header-container">
                    <h1 className="privacy-heading">Terms of <span>Service</span></h1>
                </div>
                <div className="privacy-container">
                    ...
                    <div className="privacy-content">
                        {(termsOfServiceData.sections as PolicySection[]).map((section: PolicySection) => (
                            <section
                                key={section.id}
                                id={section.id}
