...
export const ResourcesTestimonials = () => {
  const [isHovered, setIsHovered] = useState(false);
  const containerRef = useRef<HTMLDivElement | null>(null);
  const x = useMotionValue(0);
  const speed = useRef(0.5); // Scroll speed
  ...
  return (
    <section className="bm-testimonials-section" style={{ backgroundColor: "#fafafa", padding: "80px 0" }}>
