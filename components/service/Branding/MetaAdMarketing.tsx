...
export const MetaAdMarketing = () => {
    const router = useRouter();
    const [index, setIndex] = useState(0);

    const statsData = [
        { number: "3X+", label: "Higher Conversion Performance" },
        { number: "300+", label: "Campaigns Successfully Managed" },
        { number: "45%+", label: "Reduction in Cost Per Lead" },
        { number: "8X+", label: "Average ROAS Achieved" },
    ];
        ...
        <div className='bl-banner'>
            <div className="bl-hero-grid">
                <div className="bl-hero-text">
                    <h2 className="bl-subtitle">Scale Faster With Performance Driven Meta Ads</h2>
                    <h3 className="bl-headline-light"> Reach the right audience at the right time.</h3>
                    <h1 className="bl-headline-bold">
                        Turn Paid Campaigns Into <span>Predictable Revenue Streams.</span>
                    </h1>
                </div>
...
></div>
                        ...
                        <div className="bl-client-title-group">
                            ...
                            <span className="bl-client-stat"> 300+ Brands Growing With Paid Media</span>
                        </div>
                    </div>
                    ...
                    <p className="bl-client-desc">
                        Partner with our team to transform your Meta Ads campaigns into a structured performance engine that generates qualified leads, consistent sales, and measurable return on ad spend.
                    </p>
                </div>
            </div>
            ...
            <div className="bl-content-layout">
                <div className="bl-feature-card">
                    <div className="bl-feature-img-box">
                        <Image src={BrandingownerImage} alt="Meta Ads Marketing" />
                    </div>
                    <div className="bl-feature-points">
                        <div className="bl-point">
                            ...
                            <div className="bl-point-txt">
                                <h4>Campaign Strategy & Funnel Planning</h4>
                                <p>We build high converting Meta Ads strategies by defining audience segments, campaign objectives, funnel stages, and budget allocation aligned with your revenue goals.</p>
                            </div>
                        </div>
                        <div className="bl-point">
                            <div className="bl-point-icon"><Image src={Vector2} alt="Vector2" /></div>
                            <div className="bl-point-txt">
                                <h4>Creative Development & Ad Optimization</h4>
                                <p>We design scroll-stopping ad creatives, persuasive copy, and conversion-focused landing alignment that improves click-through rates and lowers cost per result.</p>
                            </div>
                        </div>
                        <div className="bl-point">
                            ...
                            <div className="bl-point-txt">
                                ...
                                <p>We continuously monitor CTR, CPM, CPC, ROAS, and conversion data to refine targeting, eliminate waste, and scale profitable campaigns efficiently.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <FadeIn direction="left" delay={0.4} className="bm-offering-promo-card">
                    ...
                    <div className="bm-offering-promo-overlay">
                        <FadeIn delay={0.6}>
                            <h3>Need clarity?</h3>
                            <p>Our performance team is ready to guide you.</p>
                        </FadeIn>

                        <div className="need_btn">
                            <div className="bm-offering-promo-text">
                                Get expert Meta Ads management support and move forward with confidence. We help you reduce cost per lead, improve return on ad spend, and generate consistent conversions through structured campaign optimization.
                            </div>
                ...
                <div className="bl-footer-section">
                    <div className="bl-footer-description">
                        <p className="bm-about-paragraph-branding">
                            <ScrollSpan>With over 3.9 billion monthly active users across Facebook and Instagram, Meta remains one of the most powerful advertising ecosystems globally. However, most businesses lose money due to poor targeting, weak creatives, and unoptimized funnels. As a performance-focused Meta Ads agency, we build structured Facebook Ads services and Instagram Ads management strategies that prioritize measurable ROI. Businesses using strategic paid social campaigns see up to 30–50% lower acquisition costs compared to unstructured boosting. Our approach focuses on data-driven optimization, audience refinement, and scaling what works to maximize revenue growth.</ScrollSpan>
                        </p>
                    </div>
                </div>
